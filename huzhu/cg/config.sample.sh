...
### 赋值要求：1、"jd_fruit@3&jd_pigPet@5"中，jd_fruit 为东东农场的活动脚本关键词，与指定数量 3 用 @ 连接，各活动用 & 分隔。
###           2、"jd_jxlhb&jd_88hb"中，由于各活动未填指定数值，因此这两个活动的全部 Cookie 按正常顺序参加活动。
# random_envs="jd_fruit@3&jd_pigPet@5"   # 针对自定义局部脚本生效
...
### 赋值要求：1、"jd_fruit@3&jd_pigPet@5"中，jd_fruit 为东东农场的活动脚本关键词，与指定数量 3 用 @ 连接，各活动用 & 分隔。
###           2、"jd_jxlhb&jd_88hb"中，由于各活动未填指定数值，因此这两个活动的全部 Cookie 按正常顺序参加活动。
priority_envs="jd_jxlhb&jd_88hb"   # 针对自定义局部脚本生效
